...
define gui.default_font = "mod_assets/fonts/AnnieUseYourTelescope-Regular.ttf"
define gui.text_font = gui.default_font
define gui.name_font = gui.default_font
define gui.interface_font = gui.default_font
