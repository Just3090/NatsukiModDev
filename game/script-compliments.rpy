...
init python:
    registerTopic(
        Topic(
            ...
            prompt=_("I think you're amazing!"),
...
init python:
    registerTopic(
        Topic(
            persistent._compliment_database,
            prompt=_("I love how confident you are!"),
...
init python:
    registerTopic(
        Topic(
            persistent._compliment_database,
            prompt=_("You're an inspiration to me!"),
...
init python:
    registerTopic(
        Topic(
            persistent._compliment_database,
            prompt=_("I love your sense of style!"),
...
init python:
    registerTopic(
        Topic(
            persistent._compliment_database,
            prompt=_("I love how thoughtful you are!"),
