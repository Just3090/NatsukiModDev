    ...
    if is_player_snap:
        ...
        if is_correct_snap:
            ...
            $ quip = renpy.substitute(random.choice([
                _("Nnnnn-!"),
                _("Ugh!{w=0.2} Come on!"),
                _("Y-{w=0.2}You're fast!"),
                _("But I was just about to call ittt!"),
                _("Just you wait,{w=0.2} [player]..."),
                _("Uuuuuu-!"),
                _("Not again!{w=0.2} Grrr..."),
                _("Damn it..."),
                _("Fudge..."),
                _("So dumb..."),
                _("Again?{w=0.2} Really?"),
                _("Ugh..."),
                _("So ridiculous..."),
                _("So dumb..."),
                _("Jeez! Whatever..."),
                _("Jeez!"),
                _("Jeeeeeez!"),
                _("Oh come on,{w=0.2} [player]!"),
                _("How are you {i}that{/i} fast?!")
            ]))
            ...
            if jn_snap._player_failed_snap_streak == 3 and not persistent.jn_snap_player_is_cheater:
                ...
                $ quip = renpy.substitute(random.choice([
                    _("Oh?{w=0.2} Someone's impatient,{w=0.2} huh?"),
                    _("Oopsie daisy,{w=0.2} [player]~.{w=0.2} Ehehe."),
                    _("Nice one,{w=0.2} dummy.{w=0.2} Ahaha!"),
                    _("Real smooth,{w=0.2} [player].{w=0.2} Ehehe."),
                    _("Ahaha!{w=0.2} What was that,{w=0.2} [player]?"),
                    _("Hey,{w=0.2} [player] -{w=0.2} you're meant to read the cards!{w=0.2} Ehehe."),
                    _("Great play,{w=0.2} dummy!{w=0.2} Ahaha!")
                ]))
        ...
        if is_correct_snap:
            $ quip = renpy.substitute(random.choice([
                ...
                _("Yes!{w=0.2} SNAP!"),
                _("Yeah!{w=0.2} SNAP!"),
                _("Yeah!{w=0.2} Snap!{w=0.2} Snap!"),
                _("Snap snap freaking snap!"),
                _("SNAAAP!{w=0.2} Ehehe."),
                _("Bam!{w=0.2} Snap!")
            ]))
            ...
            $ quip = renpy.substitute(random.choice([
                _("Sn-...{w=0.3} oh."),
                _("Snap!{w=0.2} Wait..."),
                _("SNAP!{w=0.2} Huh...?{w=0.2} O-{w=0.2}oh."),
...
screen snap_ui():
    ...
    text _("Cards down: {0}").format(len(jn_snap._cards_on_table)) size 32 xpos 1000 ypos 50 style "categorized_menu_button"
    text _("Your hand: {0}").format(len(jn_snap._player_hand)) size 22 xpos 750 ypos 125 style "categorized_menu_button"
    text _("[n_name]'s hand: {0}").format(len(jn_snap._natsuki_hand)) size 22 xpos 750 ypos 195 style "categorized_menu_button"
    text _("Turn: {0}").format(jn_snap._getCurrentTurnLabel()) size 22 xpos 750 ypos 265 style "categorized_menu_button"
