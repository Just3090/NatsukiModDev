...
init python:
    registerTopic(
        Topic(
            ...
            prompt=_("For calling you a hurtful name."),
...
init python:
    registerTopic(
        Topic(
            persistent._apology_database,
            prompt=_("For cheating during our games."),
...
init python:
    registerTopic(
        Topic(
            persistent._apology_database,
            prompt=_("For being rude to you."),
            label="apology_rude",
            unlocked=True,
        ),
        topic_group=TOPIC_TYPE_APOLOGY
...
init python:
    registerTopic(
        Topic(
            persistent._apology_database,
            prompt=_("For not taking care of myself properly."),
...
init python:
    registerTopic(
        Topic(
            persistent._apology_database,
            prompt=_("For asking you to call me a bad name."),
